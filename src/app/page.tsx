    ...
    <div className="min-h-screen pb-24">
      ...
      <main className="max-w-4xl mx-auto px-6 mt-12 space-y-24">
        <section className="text-center">
          <h2 className="text-4xl font-headline text-foreground mb-6">Welcome Home</h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            I created this space just for us. A digital sanctuary where we can revisit our favorite memories,
            celebrate our special milestones, and keep our love growing stronger every day.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 space-y-4">
            ...
            <p className="text-muted-foreground">— Maya Angelou</p>
          </div>
